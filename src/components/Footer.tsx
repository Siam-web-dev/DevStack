    ...
    <div className="max-w-[90%] sm:max-w-[90%] mx-auto mt-35 ">
      ...
      <div className="flex justify-between">
        <div className="space-y-5">
            <img src={Logo} alt="" />
            <p className="text-[#64748B] text-sm">Curated tools, technologies, and resources for developers building <br /> modern software.</p>
            <div className="flex gap-4 text-[#475569]">
                <a href="#">GitHub</a><a href="#">Twitter</a><a href="#">LinkedIn</a>
            </div>
        </div>
        <div className=" list-none space-y-2 text-[#64748B] " >
